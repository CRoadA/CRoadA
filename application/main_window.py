# from PyQt6.QtWidgets import QVBoxLayout, QMainWindow, QHBoxLayout, QPushButton, QLabel, QWidget
...
#         self.showMaximized()
#         self.setWindowTitle("CRoadA")
#         self.initialize_widgets(on_prediction_request)


#     def initialize_widgets(self, on_prediction_request : Callable[[dict], None]):
#         main_layout = QVBoxLayout()
#         info_layout = QHBoxLayout()
#         predict_btn = QPushButton("Predict")
#         result_label = QLabel("Results:")
#         map_widget = MapWindow(on_prediction_request)

#         info_layout.addWidget(map_widget)

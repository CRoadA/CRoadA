...
class BatchSequence(Sequence):
    ...
    def __init__(self, files: list[str], number_of_batches: int, batch_size: int, cut_sizes: list[tuple[int, int]]):
        self._files = files
        ...
        self._iterators = [
            CutIterator(cut_sizes=cut_sizes, sequence=self) for i_file in range(batch_size)
    ...
    def __getitem__(self) -> list[list[tuple[tuple[int, int], GridManager]]]:
...
class CutIterator:
    ...
    def __init__(self, cut_sizes: list[tuple[int, int]], sequence: BatchSequence):
    ...
    def __next__(self) -> tuple[tuple[int, int], GridManager]:
        ...
        for _ in range(self._max_x * self._max_y):
            ...
            cut_size = self._cut_sizes[self._index % len(self._cut_sizes)]
